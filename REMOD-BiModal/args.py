...
def get_args():
    ...
    parser.add_argument('--dropout', type=float, default=0.5,help="dropout rate in TuckER")
    parser.add_argument('--weightDecay', type=float, help="l2 penalty")
    parser.add_argument('--warmup_rate', type=float, default=0.1, help="warm up rate")
    ...
    parser.add_argument('--distill', default=True, type=boolean_string, help="do distillation or not")
